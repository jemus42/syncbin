...
__conda_setup="$('/Users/Lukas/Library/r-miniconda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/Lukas/Library/r-miniconda/etc/profile.d/conda.sh" ]; then
        . "/Users/Lukas/Library/r-miniconda/etc/profile.d/conda.sh"
    else
        export PATH="/Users/Lukas/Library/r-miniconda/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
